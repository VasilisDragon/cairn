...
export const SKILLS = {
  ...
  collect: {
    ...
    params: {
      ...
      maxTargetY: { type: 'number', optional: true, description: 'Optional upper Y bound for target blocks; deterministic progression uses this to avoid high-canopy bootstrap targets.' },
      allowBuriedTargets: { type: 'boolean', optional: true, default: false, description: 'Opt in after deliberate shaft/cave positioning to allow buried candidates instead of requiring surface-exposed targets.' },
      finishTree: { type: 'boolean', optional: true, default: true, description: 'For log targets, continue adjacent trunk cleanup after the requested count. Deterministic progression may set false when it needs exact bootstrap logs.' },
    },
  },
