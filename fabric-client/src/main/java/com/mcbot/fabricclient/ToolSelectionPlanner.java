...
final class ToolSelectionPlanner {
    ...
    private static boolean requiresPickaxe(String id) {
        return id.equals("stone")
            ...
            || id.equals("sandstone")
            || id.equals("chiseled_sandstone")
            || id.equals("cut_sandstone")
            || id.equals("smooth_sandstone")
            || id.equals("red_sandstone")
            || id.equals("chiseled_red_sandstone")
            || id.equals("cut_red_sandstone")
            || id.equals("smooth_red_sandstone")
            || id.equals("terracotta")
